...
function get_newest_version {
	...
	local newest_version=$( curl --silent -k -A agent --connect-timeout $CHECK_TIMEOUT_IN_SECS --location https://raw.githubusercontent.com/babun/babun/$BABUN_BRANCH/babun.version || echo "" )
	echo "$newest_version"
}
