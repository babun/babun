...
Just download the http://projects.reficio.org/babun/download[dist file], unzip it and run the install.bat script. After a few minutes babun starts automatically.
